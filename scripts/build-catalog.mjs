...
const timelineOverrides = {
  ...
  "광대들: 풍문조작단": timeline(1504, 1506, "연산군기", "여론 조작과 왕권"),
  ...
  "연악: 나의 운명": timeline(1795, 1795, "조선 후기", "조선 후기를 배경으로 한 멜로"),
  "노량: 죽음의 바다": timeline(1598, 1598, "조선 중기", "노량 해전"),
  "전,란": timeline(1592, 1593, "조선 중기", "임진왜란 전란기"),
  지충일기: timeline(1592, 1593, "조선 중기", "전란 속 기록과 생존"),
  바얌섬: timeline(1800, 1800, "조선 후기", "조선 시대 민간 설화"),
  "왕과 사는 남자": timeline(1506, 1506, "연산군기", "연산군과 광대 서사를 변주한 시대극"),
